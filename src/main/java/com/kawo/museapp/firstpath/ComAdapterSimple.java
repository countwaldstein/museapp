...
public class ComAdapterSimple extends RecyclerView.Adapter<ComAdapterSimple.ComViewHolder> {
    ...
    public ComAdapterSimple(Context context, Cursor cursor){
        mContext = context;
        mCursor = cursor;
    }
    ...
    public ComAdapterSimple(ArrayList<ComRecyclerItem> comRecyclerItemArrayList){
    ...
    public ComViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.comrecycler_item_simple,parent,false);
